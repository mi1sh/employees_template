...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      data: [
        {name: 'John S.', salary: 800, increase: false, star: true, id: 1},
  ...
  deleteItem = (id) => {
    this.setState(({data}) => {
      ...
      //* сохранение иммутабельности data и удаление по индексу 
  ...
  render() {
    ...
    return (
      <div className="app">
        <AppInfo employees={employees} employeesIncrease={employeesIncrease}/>
